...
<head>
    <meta charset="utf-8">
    <title>rekit-core - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title">rekit-core</h1>
...
<article>
    <div class="container-overview">
            ...
            <div class="description"><p>The default module of the rekit-core package. It does two things:</p>
<ol>
<li>Wraps modularized APIs to Rekit core commands.</li>
<li>Exports other modules. i.e. <code>require('rekit-core').component</code> equals to <code>require('rekit-core/component')</code>.</li>
</ol></div>
...
<h4 class="name" id=".action"><span class="type-signature">(static, constant) </span>action<span class="type-signature"></span></h4>
...
<div class="description">
    <p>Quick access to rekit-core/action.</p>
</div>
...
<h4 class="name" id=".app"><span class="type-signature">(static, constant) </span>app<span class="type-signature"></span></h4>
...
<div class="description">
    <p>Quick access to rekit-core/app.</p>
</div>
...
<h4 class="name" id=".component"><span class="type-signature">(static, constant) </span>component<span class="type-signature"></span></h4>
...
<div class="description">
    <p>Quick access to rekit-core/component.</p>
</div>
...
<h4 class="name" id=".feature"><span class="type-signature">(static, constant) </span>feature<span class="type-signature"></span></h4>
...
<div class="description">
    <p>Quick access to rekit-core/feature.</p>
</div>
...
<h4 class="name" id=".style"><span class="type-signature">(static, constant) </span>style<span class="type-signature"></span></h4>
...
<div class="description">
    <p>Quick access to rekit-core/style.</p>
</div>
...
<h4 class="name" id=".test"><span class="type-signature">(static, constant) </span>test<span class="type-signature"></span></h4>
...
<div class="description">
    <p>Quick access to rekit-core/test.</p>
</div>
...
<h4 class="name" id=".utils"><span class="type-signature">(static, constant) </span>utils<span class="type-signature"></span></h4>
...
<div class="description">
    <p>Quick access to rekit-core/utils.</p>
</div>
...
<h4 class="name" id=".vio"><span class="type-signature">(static, constant) </span>vio<span class="type-signature"></span></h4>
...
<div class="description">
    <p>Quick access to rekit-core/vio.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="index.js.html">index.js</a>, <a href="index.js.html#line68">line 68</a>
    </li></ul></dd>
...
<div class="description">
    ...
    <h4 class="name" id=".addAction"><span class="type-signature">(static) </span>addAction<span class="signature">(feature, name)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Add an action and its unit test.</p>
</div>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>the feature where to create the action.</p></td>
        </tr>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>the action name, will be converted to camel case.</p></td>
        </tr>
    ...
    <h4 class="name" id=".addAsyncAction"><span class="type-signature">(static) </span>addAsyncAction<span class="signature">(feature, name)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Add an async action using redux-thunk and its unit test.</p>
</div>
...
<span class="param-type">string</span>
    ...
    <h4 class="name" id=".addComponent"><span class="type-signature">(static) </span>addComponent<span class="signature">(feature, name, args)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Add a component including unit test and style files. It wraps APIs from <code>component</code>, <code>style</code> and <code>test</code>.</p>
</div>
    ...
    <h5>Example</h5>
        ...
        <p class="code-caption">Create a container component</p>
    
    <pre class="prettyprint"><code>const rekitCore = require('rekit-core');
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>the feature where to create the component.</p></td>
        </tr>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>the component name, will be converted to pascal case.</p></td>
        </tr>
...
<span class="param-type">object</span>
            ...
            <td class="description last"><p>other args.</p></td>
        </tr>
    ...
    <h4 class="name" id=".addFeature"><span class="type-signature">(static) </span>addFeature<span class="signature">(name)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Add a feature with one sample component. Besides creating feature folder and files,
it also registers reducer, router config, style to root config of the app.</p>
</div>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>the feature name.</p></td>
        </tr>
    ...
    <h4 class="name" id=".handleCommand"><span class="type-signature">(static) </span>handleCommand<span class="signature">()</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Handle the parse result of Rekit command, like <code>rekit add component home/hello</code>.</p>
</div>
    ...
    <h4 class="name" id=".moveAction"><span class="type-signature">(static) </span>moveAction<span class="signature">(source, target)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Move/rename an action including unit test.</p>
</div>
...
<span class="param-type">object</span>
            ...
            <td class="description last"><p>which action to be moved, in form of { name: {string}, feature: {string} }.</p></td>
        </tr>
...
<span class="param-type">object</span>
            ...
            <td class="description last"><p>where to move, in form of { name: {string}, feature: {string} }.</p></td>
        </tr>
    ...
    <h4 class="name" id=".moveAsyncAction"><span class="type-signature">(static) </span>moveAsyncAction<span class="signature">(source, target)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Move/rename an async action including unit test.</p>
</div>
...
<span class="param-type">ElementArg</span>
            ...
            <td class="description last"><p>Which action to be moved.</p></td>
        </tr>
...
<span class="param-type">ElementArg</span>
            ...
            <td class="description last"><p>Where to move.</p></td>
        </tr>
    ...
    <h4 class="name" id=".moveComponent"><span class="type-signature">(static) </span>moveComponent<span class="signature">(source, target)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Move/rename a component including unit test and style files. It wraps APIs from <code>component</code>, <code>style</code> and <code>test</code>.</p>
</div>
    ...
    <h5>Example</h5>
        ...
        <p class="code-caption">Rename TopicList to Topics</p>
...
<span class="param-type">object</span>
            ...
            <td class="description last"><p>which component to be moved, in form of { name: {string}, feature: {string} }.</p></td>
        </tr>
...
<span class="param-type">object</span>
    ...
    <h4 class="name" id=".moveFeature"><span class="type-signature">(static) </span>moveFeature<span class="signature">(oldName, newName)</span><span class="type-signature"></span></h4>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>Old name of the feature.</p></td>
        </tr>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>New name of the feature.</p></td>
        </tr>
    ...
    <h4 class="name" id=".removeAction"><span class="type-signature">(static) </span>removeAction<span class="signature">(feature, name)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="index.js.html">index.js</a>, <a href="index.js.html#line238">line 238</a>
    </li></ul></dd>
...
<div class="description">
    <p>Remove an action and its unit test.</p>
</div>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>the feature of the action.</p></td>
        </tr>
...
<span class="param-type">string</span>
    ...
    <h4 class="name" id=".removeAsyncAction"><span class="type-signature">(static) </span>removeAsyncAction<span class="signature">(feature, name)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Remove an async action and its unit test.</p>
</div>
...
<span class="param-type">string</span>
    ...
    <h4 class="name" id=".removeComponent"><span class="type-signature">(static) </span>removeComponent<span class="signature">(feature, name)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Remove a component including unit test and style files. It wraps APIs from <code>component</code>, <code>style</code> and <code>test</code>.</p>
</div>
    ...
    <h5>Example</h5>
        ...
        <p class="code-caption">Remove a container component</p>
...
<span class="param-type">string</span>
    ...
    <h4 class="name" id=".removeFeature"><span class="type-signature">(static) </span>removeFeature<span class="signature">(name)</span><span class="type-signature"></span></h4>
...
<h4 class="name" id="~ElementArg">ElementArg</h4>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>The feature of the element.</p></td>
        </tr>
...
<div class="description">
    <p>The combination of feature and name of an element like component.</p>
</div>
