...
<article>
    <div class="container-overview">
            ...
            <div class="description"><p>The common utility module. It provides various tools for managing a Rekit app.</p></div>
...
<dl class="details">
    ...
    <h4 class="name" id=".joinPath"><span class="type-signature">(static) </span>joinPath<span class="signature">()</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>The unified version of 'path.join'. It forces forward slash ('/') on both unix like or windows system.
It also normalizes the path to emmit double slash and '..'.</p>
</div>
    ...
    <pre class="prettyprint"><code>const utils = require('rekit-core').utils;
...
// p1 => 'c:/def'</code></pre>
    ...
    <h4 class="name" id=".mapSrcFile"><span class="type-signature">(static) </span>mapSrcFile<span class="signature">(filePath)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="utils.js.html">utils.js</a>, <a href="utils.js.html#line205">line 205</a>
    </li></ul></dd>
...
<div class="description">
    <p>Get the full path by a relative path to 'src'.</p>
</div>
...
// => /path/to/project/src/common/configStore.js</code></pre>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>The file path relative to project's 'src' folder.</p></td>
        </tr>
    ...
    <h4 class="name" id=".setSilent"><span class="type-signature">(static) </span>setSilent<span class="signature">(isSilent)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="utils.js.html">utils.js</a>, <a href="utils.js.html#line28">line 28</a>
    </li></ul></dd>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>isSilent</code></td>
...
<span class="param-type">boolean</span>
            ...
            <td class="description last"><p>Whether to output logs.</p></td>
        </tr>
    ...
    <h4 class="name" id="~error"><span class="type-signature">(inner) </span>error<span class="signature">(msg)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="utils.js.html">utils.js</a>, <a href="utils.js.html#line68">line 68</a>
    </li></ul></dd>
...
<div class="description">
    <p>Log an error message to console. It respects the setSilent switch.</p>
</div>
...
<span class="param-type">string</span>
    ...
    <h4 class="name" id="~fatalError"><span class="type-signature">(inner) </span>fatalError<span class="signature">(msg)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Throw a fatal error and log an error message.</p>
</div>
...
<span class="param-type">string</span>
    ...
    <h4 class="name" id="~getActionType"><span class="type-signature">(inner) </span>getActionType<span class="signature">(feature, action)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="utils.js.html">utils.js</a>, <a href="utils.js.html#line165">line 165</a>
    </li></ul></dd>
...
<div class="description">
    <p>Get action type constant for a sync action. It uses UPPER_SNAKE_CASE and combines feature name and action name.</p>
</div>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>The feature name of the action.</p></td>
        </tr>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>The action name.</p></td>
        </tr>
    ...
    <h4 class="name" id="~getAsyncActionTypes"><span class="type-signature">(inner) </span>getAsyncActionTypes<span class="signature">(feature, action)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="utils.js.html">utils.js</a>, <a href="utils.js.html#line185">line 185</a>
    </li></ul></dd>
...
<div class="description">
    <p>Get action type constants for an async action. It uses UPPER_SNAKE_CASE and combines feature name and action name.</p>
</div>
...
<span class="param-type">string</span>
    ...
    <h4 class="name" id="~getFullPath"><span class="type-signature">(inner) </span>getFullPath<span class="signature">(relPath)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Get the full path of a relative path to the project root.</p>
</div>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>relPath</code></td>
...
<span class="param-type">string</span>
    ...
    <h4 class="name" id="~getPkgJson"><span class="type-signature">(inner) </span>getPkgJson<span class="signature">()</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="utils.js.html">utils.js</a>, <a href="utils.js.html#line117">line 117</a>
    </li></ul></dd>
...
<div class="description">
    <p>Get the current project's package.json.</p>
</div>
    ...
    <h4 class="name" id="~getProjectRoot"><span class="type-signature">(inner) </span>getProjectRoot<span class="signature">()</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Get the project root. By default it finds the Rekit project root of which the command is run.</p>
</div>
    ...
    <h4 class="name" id="~getRelativePath"><span class="type-signature">(inner) </span>getRelativePath<span class="signature">(fullPath)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Get the relative path to the project root by given full path.</p>
</div>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>A full path string.</p></td>
        </tr>
    ...
    <h4 class="name" id="~log"><span class="type-signature">(inner) </span>log<span class="signature">(msg)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="utils.js.html">utils.js</a>, <a href="utils.js.html#line52">line 52</a>
    </li></ul></dd>
...
<div class="description">
    <p>Log a message to console. It respects the setSilent switch.</p>
</div>
...
<span class="param-type">string</span>
    ...
    <h4 class="name" id="~setPkgJson"><span class="type-signature">(inner) </span>setPkgJson<span class="signature">()</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Set the current project's package.json.</p>
</div>
    ...
    <h4 class="name" id="~setProjectRoot"><span class="type-signature">(inner) </span>setProjectRoot<span class="signature">(root)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>By default Rekit will try to find the current Rekit project root. But you can also manually set it by calling this method.</p>
</div>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>The project root.</p></td>
        </tr>
    ...
    <h4 class="name" id="~warn"><span class="type-signature">(inner) </span>warn<span class="signature">(msg)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="utils.js.html">utils.js</a>, <a href="utils.js.html#line60">line 60</a>
    </li></ul></dd>
...
<div class="description">
    <p>Log a warning message to console. It respects the setSilent switch.</p>
</div>
