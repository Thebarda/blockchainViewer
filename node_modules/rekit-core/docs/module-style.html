...
<head>
    <meta charset="utf-8">
    <title>style - Documentation</title>
...
<article>
    <div class="container-overview">
            ...
            <div class="description"><p>Style manager. It manage style files for components. Usually used with component manage.</p></div>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="style.js.html">style.js</a>, <a href="style.js.html#line3">line 3</a>
    </li></ul></dd>
    ...
    <h4 class="name" id=".add"><span class="type-signature">(static) </span>add<span class="signature">(feature, component)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="style.js.html">style.js</a>, <a href="style.js.html#line27">line 27</a>
    </li></ul></dd>
...
<div class="description">
    <p>Add a style file for a component. It create the style file with the extension 'cssExt' configured in 'rekit' section of package.json.</p>
</div>
    ...
    <pre class="prettyprint"><code>const style = require('rekit-core').style;

// create a file named 'Hello.less' in feature 'home'.
style.add('home', 'Hello');</code></pre>
...
<span class="param-type">string</span>
    ...
    <h4 class="name" id=".remove"><span class="type-signature">(static) </span>remove<span class="signature">(feature, component)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="style.js.html">style.js</a>, <a href="style.js.html#line63">line 63</a>
    </li></ul></dd>
...
<div class="description">
    <p>Move/rename a style file for a component.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="style.js.html">style.js</a>, <a href="style.js.html#line50">line 50</a>
    </li></ul></dd>
...
<div class="description">
    <p>Remove a style file for a component.</p>
</div>
