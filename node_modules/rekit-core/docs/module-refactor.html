...
<div id="main">
    ...
    <h1 class="page-title">refactor</h1>
...
<article>
    <div class="container-overview">
            ...
            <div class="description"><p>Simple refactor for es6 code.</p></div>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="refactor_index.js.html">refactor/index.js</a>, <a href="refactor_index.js.html#line3">line 3</a>
    </li></ul></dd>
    ...
    <h4 class="name" id=".addExportFrom"><span class="type-signature">(static) </span>addExportFrom<span class="signature">(ast, moduleSource)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="refactor_importExport.js.html">refactor/importExport.js</a>, <a href="refactor_importExport.js.html#line149">line 149</a>
    </li></ul></dd>
...
<div class="description">
    <p>Export from a given module source. This methods operates export ... from statement:</p>
</div>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>Which module to manage export from statement.</p></td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>moduleSource</code></td>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>From which module source to add import from. If not found, the create an import line.</p></td>
        </tr>
    ...
    <h4 class="name" id=".addImportFrom"><span class="type-signature">(static) </span>addImportFrom<span class="signature">(ast, moduleSource)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="refactor_importExport.js.html">refactor/importExport.js</a>, <a href="refactor_importExport.js.html#line46">line 46</a>
    </li></ul></dd>
...
<div class="description">
    <p>Import from a given module source. This methods operates import statement:
import defaultImmport, { namedImport ... } from './module-source';
It noly supports es6 modules import but not commonJS or AMD or others...</p>
</div>
    ...
    <pre class="prettyprint"><code>const refactor = require('rekit-core').refactor;
refactor.addImportFrom(file, './some-module', 'SomeModule', ['method1', 'method2']);
// it generates: import SomeModule, { method1, method2 } from './some-module';</code></pre>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>Which module to manage import statement.</p></td>
        </tr>
...
<span class="param-type">string</span>
    ...
    <h4 class="name" id=".addToArray"><span class="type-signature">(static) </span>addToArray<span class="signature">(ast, varName, identifierName)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="refactor_array.js.html">refactor/array.js</a>, <a href="refactor_array.js.html#line149">line 149</a>
    </li></ul></dd>
...
<div class="description">
    <p>Add an identifier to the array of the name 'varName'.
It only finds the first matched array in the top scope of ast.</p>
</div>
...
// code changes to: const arr = [a, b, c, d];</code></pre>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>The ast tree or the js file path to find the array.</p></td>
        </tr>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>The variable name of the array definition.</p></td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>identifierName</code></td>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>The identifier to append to array.</p></td>
        </tr>
    ...
    <h4 class="name" id=".removeFromArray"><span class="type-signature">(static) </span>removeFromArray<span class="signature">(ast, varName, identifierName)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="refactor_array.js.html">refactor/array.js</a>, <a href="refactor_array.js.html#line178">line 178</a>
    </li></ul></dd>
...
<div class="description">
    <p>Remove an identifier from the array of the name 'varName'.
It only finds the first matched array in the global scope of ast.</p>
</div>
...
// code changes to: const arr = [b, c];</code></pre>
...
<span class="param-type">string</span>
    ...
    <h4 class="name" id=".renameClassName"><span class="type-signature">(static) </span>renameClassName<span class="signature">(ast, oldName)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="refactor_cls.js.html">refactor/cls.js</a>, <a href="refactor_cls.js.html#line24">line 24</a>
    </li></ul></dd>
...
<div class="description">
    <p>Rename a es6 class name in a module. Only rename the class definition and its reference in the module.
It will not find other files to rename reference.</p>
</div>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>Which module to rename class name.</p></td>
        </tr>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>The old class name.</p></td>
        </tr>
    ...
    <h4 class="name" id=".renameFunctionName"><span class="type-signature">(static) </span>renameFunctionName<span class="signature">(ast, oldName)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="refactor_func.js.html">refactor/func.js</a>, <a href="refactor_func.js.html#line23">line 23</a>
    </li></ul></dd>
...
<div class="description">
    <p>Rename a function name in a module.</p>
</div>
    ...
    <pre class="prettyprint"><code>// function MyFunc() {
//   ...
// }
const refactor = require('rekit-core').refactor;
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>Which module to rename function.</p></td>
        </tr>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>The old function name.</p></td>
        </tr>
    ...
    <h4 class="name" id=".renameIdentifier"><span class="type-signature">(static) </span>renameIdentifier<span class="signature">(ast, oldName)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="refactor_identifier.js.html">refactor/identifier.js</a>, <a href="refactor_identifier.js.html#line35">line 35</a>
    </li></ul></dd>
...
<div class="description">
    <p>Rename an top scope identifier in a module. If first finds the definition node of the given name.
Then rename all identifiers those refer to that definition node.</p>
</div>
    ...
    <pre class="prettyprint"><code>// import { m1 } from './some-module';
// m1.doSomething();
...
// => m2.doSomething();
// => function () { const m1 = 'abc'; } // m1 is not renamed.</code></pre>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>Which module to rename an identifier.</p></td>
        </tr>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>The old identifier name.</p></td>
        </tr>
