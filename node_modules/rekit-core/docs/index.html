...
<div id="main">
    ...
    <section class="readme">
        <article><h2>Rekit core API reference</h2><p>Rekit core provides the core APIs for managing Rekit elements like features, components, actions, etc.</p>
<p>You can create plugins using Rekit core APIs to extend Rekit's capability.</p></article>
    </section>
