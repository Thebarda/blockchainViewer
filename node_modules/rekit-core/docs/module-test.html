...
<article>
    <div class="container-overview">
            ...
            <div class="description"><p>Unit test manager. Manages tests for actions/reducers and components. Usually used with action/component manager.</p></div>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="test.js.html">test.js</a>, <a href="test.js.html#line3">line 3</a>
    </li></ul></dd>
    ...
    <h4 class="name" id=".add"><span class="type-signature">(static) </span>add<span class="signature">(feature, name, args<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="test.js.html">test.js</a>, <a href="test.js.html#line29">line 29</a>
    </li></ul></dd>
...
<div class="description">
    <p>Add the unit test boilerplate file for a component.</p>
</div>
    ...
    <pre class="prettyprint"><code>const test = require('rekit-core').test;
test.add('home', 'Hello');

// Result => Create the unit test boilerplate file at: 'tests/features/home/Hello.test.js'.</code></pre>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>The component name.</p></td>
        </tr>
...
<span class="param-type">Object</span>
            ...
            <td class="description last"><p>The args passed to rekit-core/template.</p>
                <h6>Properties</h6>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>The template file to create test file.</p></td>
        </tr>
    ...
    <h4 class="name" id=".addAction"><span class="type-signature">(static) </span>addAction<span class="signature">(feature, name, args<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="test.js.html">test.js</a>, <a href="test.js.html#line111">line 111</a>
    </li></ul></dd>
...
<div class="description">
    <p>Add the unit test boilerplate file for an action (using different templates for sync or async).</p>
</div>
...
// Result => Create the unit test boilerplate file at: 'tests/features/home/redux/doSomething.test.js'.</code></pre>
...
<span class="param-type">string</span>
        ...
        <tr>
                ...
                <td class="name"><code>isAsync</code></td>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>Whether the action is async.</p></td>
        </tr>
    ...
    <h4 class="name" id=".move"><span class="type-signature">(static) </span>move<span class="signature">(source, target)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="test.js.html">test.js</a>, <a href="test.js.html#line61">line 61</a>
    </li></ul></dd>
...
<div class="description">
    <p>Move/rename the unit test file for a component.</p>
</div>
...
<span class="param-type">ElementArg</span>
            ...
            <td class="description last"><p>Which component test to move.</p></td>
        </tr>
...
<span class="param-type">ElementArg</span>
            ...
            <td class="description last"><p>The target location of the component test.</p></td>
        </tr>
    ...
    <h4 class="name" id=".moveAction"><span class="type-signature">(static) </span>moveAction<span class="signature">(source, target, args<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="test.js.html">test.js</a>, <a href="test.js.html#line149">line 149</a>
    </li></ul></dd>
...
<div class="description">
    <p>Move/rename the unit test file for an action.</p>
</div>
...
<span class="param-type">ElementArg</span>
            ...
            <td class="description last"><p>Which action test to move.</p></td>
        </tr>
...
<span class="param-type">ElementArg</span>
            ...
            <td class="description last"><p>The target location of the action test.</p></td>
        </tr>
...
<span class="param-type">Object</span>
            ...
            <td class="description last"><p>Only used to indicates if it's async.</p>
                <h6>Properties</h6>
...
<span class="param-type">Object</span>
            ...
            <td class="description last"><p>Whether it's an async action.</p></td>
        </tr>
    ...
    <h4 class="name" id=".remove"><span class="type-signature">(static) </span>remove<span class="signature">(feature, name)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="test.js.html">test.js</a>, <a href="test.js.html#line50">line 50</a>
    </li></ul></dd>
...
<div class="description">
    <p>Remove the unit test file for a component.</p>
</div>
...
// Result => Delete the test file of: 'tests/features/home/Hello.test.js'.</code></pre>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="test.js.html">test.js</a>, <a href="test.js.html#line136">line 136</a>
    </li></ul></dd>
...
<div class="description">
    <p>Remove the unit test file for an action (either sync or async).</p>
</div>
