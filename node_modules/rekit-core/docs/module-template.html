...
<article>
    <div class="container-overview">
            ...
            <div class="description"><p>Template manager. A simple wrapper of lodash template for using vio internally.</p></div>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="template.js.html">template.js</a>, <a href="template.js.html#line3">line 3</a>
    </li></ul></dd>
    ...
    <h4 class="name" id=".generate"><span class="type-signature">(static) </span>generate<span class="signature">(targetPath, args)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="template.js.html">template.js</a>, <a href="template.js.html#line53">line 53</a>
    </li></ul></dd>
...
<div class="description">
    <p>Process the template file and save the result to virtual IO.
If the target file has existed, throw fatal error and exit.</p>
</div>
    ...
    <pre class="prettyprint"><code>const template = require('rekit-core').template;
...
// NOTE the result is only in vio, you need to call vio.flush() to write to disk.</code></pre>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>The path to save the result.</p></td>
        </tr>
...
<span class="param-type">Object</span>
            ...
            <td class="description last"><p>The path to save the result.</p>
                <h6>Properties</h6>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>The template string to process.</p></td>
        </tr>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>If no 'template' defined, read the template file to process. One of template and templateFile should be provided.</p></td>
        </tr>
...
<span class="param-type">Object</span>
            ...
            <td class="description last"><p>The context to process the template.</p></td>
        </tr>
    ...
    <h4 class="name" id=".readTemplate"><span class="type-signature">(static) </span>readTemplate<span class="signature">(file)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="template.js.html">template.js</a>, <a href="template.js.html#line25">line 25</a>
    </li></ul></dd>
...
<div class="description">
    <p>Read a template content, if the file isn't absolute path, find it in rekit-core/templates folder. Otherwise read the file content.
If the file doesn't exist, throw fatal error and exit.</p>
</div>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>The path to the template file.</p></td>
        </tr>
