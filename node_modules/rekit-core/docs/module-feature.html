...
<article>
    <div class="container-overview">
            ...
            <div class="description"><p>Feature manager. It creates the basic feature folder structure and provides the capability to rename or remove it.</p></div>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="feature.js.html">feature.js</a>, <a href="feature.js.html#line3">line 3</a>
    </li></ul></dd>
    ...
    <h4 class="name" id=".add"><span class="type-signature">(static) </span>add<span class="signature">(name)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="feature.js.html">feature.js</a>, <a href="feature.js.html#line30">line 30</a>
    </li></ul></dd>
...
<div class="description">
    <p>Add a feature. Create the basic folder strcutre of a feature, such as files of <code>index.js</code>, <code>style.less</code>, <code>redux</code> folder, etc.</p>
</div>
    ...
    <h5>Example</h5>
        ...
        <p class="code-caption">Create a feature</p>
    
    <pre class="prettyprint"><code>const feature = require('rekit-core').feature;
feature.add('customer'); // create a feature named 'customer'
// Result => Create a folder named 'customer' in 'src/features' folder.</code></pre>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>feature name.</p></td>
        </tr>
    ...
    <h4 class="name" id=".move"><span class="type-signature">(static) </span>move<span class="signature">(oldName, newName)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="feature.js.html">feature.js</a>, <a href="feature.js.html#line84">line 84</a>
    </li></ul></dd>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>The old name.</p></td>
        </tr>
...
<span class="param-type">string</span>
    ...
    <h4 class="name" id=".remove"><span class="type-signature">(static) </span>remove<span class="signature">(name)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="feature.js.html">feature.js</a>, <a href="feature.js.html#line73">line 73</a>
    </li></ul></dd>
