...
<div id="main">
    ...
    <h1 class="page-title">constant</h1>
...
<article>
    <div class="container-overview">
            ...
            <div class="description"><p>Constant manager. It manages all constants of a feature. Constants are very useful for the communication between actions and reducers.
They may be used across features.
This constant manager exports APIs to create/rename/remove constants. Usually used with the action manager as Rekit does.</p></div>
...
<dl class="details">
    ...
    <h4 class="name" id=".add"><span class="type-signature">(static) </span>add<span class="signature">(feature, name)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="constant.js.html">constant.js</a>, <a href="constant.js.html#line32">line 32</a>
    </li></ul></dd>
...
<div class="description">
    <p>Add a constant definition to a feature's <code>redux/constants.js</code> file, it forces UPPER_SNAKE_CASE.</p>
</div>
    ...
    <h5>Example</h5>
        ...
        <p class="code-caption">Add a new constant</p>
    
    <pre class="prettyprint"><code>const constant = require('rekit-core').constant;
...
// Result => added a new line `const FETCH_TOPIC_LIST_BEGIN = 'FETCH_TOPIC_LIST_BEGIN';` to `home/redux/constants.js`.</code></pre>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="constant.js.html">constant.js</a>, <a href="constant.js.html#line67">line 67</a>
    </li></ul></dd>
...
<div class="description">
    <p>Remove a constant definition from a feature's <code>redux/constants.js</code> file, it forces UPPER_SNAKE_CASE.</p>
</div>
...
<span class="param-type">string</span>
    ...
    <h4 class="name" id=".rename"><span class="type-signature">(static) </span>rename<span class="signature">(feature, name)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="constant.js.html">constant.js</a>, <a href="constant.js.html#line47">line 47</a>
    </li></ul></dd>
...
<div class="description">
    <p>Rename a constant definition in a feature's <code>redux/constants.js</code> file, it forces UPPER_SNAKE_CASE.</p>
</div>
